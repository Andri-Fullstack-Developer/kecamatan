...
<head>
    ...
    <title>Login || Admin Kecamatan</title>
...
<body class="bg-neutral-950">
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-12 bg-neutral-950 lg:bg-neutral-950 flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <img src="{{asset('img/hourse.png')}}" alt="">
                    </div>
                    <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Tuban</div>
                </div>
            </div>
